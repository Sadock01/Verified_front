...
class SmartPaginationWidget extends StatelessWidget {
    ...
    return Row(
      ...
      children: [
        ...
        if (state.currentPage > 1)
          InkWell(
            onTap: () {
              context.read<ReportCubit>().goToPage(state.currentPage - 1);
            },
            child: Container(
  ...
  List<Widget> _buildPageNumbers(BuildContext context, ReportState state, bool isLight) {
  ...
  Widget _buildPageNumber(BuildContext context, int pageNumber, int currentPage, bool isLight) {
    ...
    return InkWell(
      onTap: () {
        context.read<ReportCubit>().goToPage(pageNumber);
      },
      child: Container(
