...
class CollaborateurScreen extends StatefulWidget {
  const CollaborateurScreen({super.key});

  @override
  State<CollaborateurScreen> createState() => _CollaborateurScreenState();
}

class _CollaborateurScreenState extends State<CollaborateurScreen> {
  @override
