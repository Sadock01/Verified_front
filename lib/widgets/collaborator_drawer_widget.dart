...
class CollaboratorDrawerWidget extends StatefulWidget {
  const CollaboratorDrawerWidget({super.key});

  @override
  State<CollaboratorDrawerWidget> createState() => _CollaboratorDrawerWidgetState();
}

class _CollaboratorDrawerWidgetState extends State<CollaboratorDrawerWidget> {
                      ...
                      Container(
                        ...
                        child: TextButton(
                          onPressed: () {
                            ...
                            context.go('/collaborateur/List-collaborateurs');
                          },
                          style: ButtonStyle(
                            overlayColor: MaterialStateProperty.resolveWith<Color?>(
                              (Set<MaterialState> states) {
                      ...
                      Container(
                        ...
                        child: TextButton(
                          onPressed: () {
                            ...
                            context.go('/collaborateur/nouveau-collaborateur');
                          },
                          style: ButtonStyle(
                            overlayColor: MaterialStateProperty.resolveWith<Color?>(
                              (Set<MaterialState> states) {
